 ...
 * http://stackoverflow.com/questions/20375067/java-decimal-string-sort
 *
 * Example usage: String[] k1 = { "0.10", "0.2", "0.1", "0", "1.10", "1.2",
 * "1.1", "1", "2.10", "2", "2.2", "2.1" }; Arrays.sort(k1, new
 * VersionNumberComparator()); System.out.println(Arrays.asList(k1));
 * 
 */
